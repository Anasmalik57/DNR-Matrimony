...
const ProfileDetailByIDPage = () => {
  ...
  const handleEnquireNow = async () => {
    ...
    if (
      ...
      !formData.enquirerPhone ||
      !formData.enquirerDescription ||
              ...
              <div className="px-6 pb-8 -mt-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-center pt-4">
                    ...
                    >
                      Developed by{" "}
                      <span className="font-semibold text-[#C4887C]">
                        NoDeskDeveloper
                      </span>{" "}
                      team
                    </Link>
                    ...
                    <CreatableSelect
                      ...
                      value={
                        formData.enquirerReligion
                          ? {
                              label: formData.enquirerReligion,
                  ...
                  <div>
                    ...
                    <CreatableSelect
                      ...
                      value={
                        formData.enquirerCaste
                          ? {
                              label: formData.enquirerCaste,
                              value: formData.enquirerCaste,
                            }
                          : null
                      }
                      onChange={(selected) =>
...
export default ProfileDetailByIDPage;
