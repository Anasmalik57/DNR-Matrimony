        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-rose-100 leading-relaxed text-sm">
              The most trusted matchmaking service for the Telugu community in Andra-Pradesh, Telangana & Karnataka. We bring hearts together with tradition, privacy, and modern technology.
            </p>
